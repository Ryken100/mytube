...
namespace Microsoft.Graphics.Canvas.Text
{
	...
	public sealed class CanvasTextFormat : ICanvasTextFormat, IDisposable
	{
		...
		public static extern string[] GetSystemFontFamilies([In] IReadOnlyList<string> localeList);
	}
}
